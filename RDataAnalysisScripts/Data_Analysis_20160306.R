...
#   maxIter=4000;
 ...
 # matrixName <- "ex13";
  ...
  # solver_prefix<-c("bcbcg_4_no1_s2_b1", "bcbcg_4_no2_s2_b1","bcbcg_4_no3_s2_b1",
  #                  "bcbcg_4_no6_s2_b1",
  #                  "bcbcg_4_no1_s4_b1", "bcbcg_4_no2_s4_b1","bcbcg_4_no3_s4_b1",
  #                  "bcbcg_4_no6_s4_b1",
  #                  "bcbcg_4_no1_s6_b1", "bcbcg_4_no2_s6_b1","bcbcg_4_no3_s6_b1",
  #                  "bcbcg_4_no6_s6_b1")
  # LineName<-c("x", "s2_eigs (Matlab)", "s2_Gerschgorin Theorem", "s2_Power iteration (max+min)",
  #             "s2_Power iteration (max) + Gerschgorin (min)",
  #             "s4_eigs (Matlab)", "s4_Gerschgorin Theorem", "s4_Power iteration (max+min)",
  #             "s4_Power iteration (max) + Gerschgorin (min)",
  #             "s6_eigs (Matlab)", "s6_Gerschgorin Theorem", "s6_Power iteration (max+min)",
  #             "s6_Power iteration (max) + Gerschgorin (min)")
  ...
  PlotConvergenceHistoryWithXY_SingleMatrixMultipleSolver_region(dataToPlot, tol=tolerence
                                                         ...
                                                         , startP=0, endP=50, titleSize = 1.5
                                                         )
}
