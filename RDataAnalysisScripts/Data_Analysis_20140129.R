...
#   LineName<-c("x"  ,"bcg_rankInfo_m2_", "bcg_rankInfo_m4_", "bcg_rankInfo_m8_", "bcg_rankInfo_m16_")
  ##############################mesh2e1
#   solver_prefix<-c( "bcg_1_rankInfo_m4_", "bcg_1_rankInfo_m8_", "bcg_1_rankInfo_m10_"
#                   , "bcg_qr_rankInfo_m4_", "bcg_qr_rankInfo_m8_", "bcg_qr_rankInfo_m10_")
#   LineName<-c("x","bcg_1_rankInfo_m4_", "bcg_1_rankInfo_m8_", "bcg_1_rankInfo_m10_"
#                   , "bcg_qr_rankInfo_m4_", "bcg_qr_rankInfo_m8_", "bcg_qr_rankInfo_m10_")
  ##############################
  ...
  for (prefix_id in 1:length(solver_prefix)) {
    ...
    Temp<-MatrixTemp[,2]; #column 2R or 3P
    length(Temp)<-maxIter;
    dataToPlot<-cbind(dataToPlot, Temp)
  }
  dataToPlot[is.na(dataToPlot)]<-lineLowerBound;
  colnames(dataToPlot)<-LineName;
  PlotConvergenceHistoryWithXY_SingleMatrixMultipleSolver_plain(dataToPlot, x_axis_gap=10, tol=tolerence 
