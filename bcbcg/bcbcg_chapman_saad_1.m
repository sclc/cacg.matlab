function [X,hist_residual] = bcbcg_chapman_saad_1(A, RHS, s_k, blocksize, X, eigenValue_max, eigenValue_min,maxIters, tol)
...
RHS(:,2:blocksize) = eigenVecCluster(:,2:blocksize);
R = RHS - A*X;
PHI = X'* (0.5 * A * X - RHS);
InterestedColIdx=1;
